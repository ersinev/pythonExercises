...
sentence1 = "MDEneEdU oAXnkgaCteJE vMtokdrHarpltSKuspcc aaaudAev xzsRkVrSoDlolMernyFZpRHQDdkX QggivNajnoQU youKdSeq lnegtwrvatpeXeUu"

def decode5(sentence):
    third = decode3(sentence)
    second = decode4(third)
    first = decode2(second)
    last = decode1(first)

    return last

print(decode5(sentence1))
